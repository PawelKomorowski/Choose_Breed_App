...
public interface BreedInfoRepository extends JpaRepository<BreedsInfo, String> {
    ...
    List<BreedsInfo> findByParams(@Param("size") Collection<Size> size, @Param("cleaningDifficulty") Collection<CleaningDifficulty> cleaningDifficulty,
                                  @Param("trainingDifficulty") Collection<TrainDifficulty> trainingDifficulty, @Param("hairLength") Collection<HairLength> hairLength,
